...
typedef struct qsocket_s
{
    ...
    int disconnected :1;   //qboolean
    int canSend :1;        //qboolean
    int sendNext :1;       //qboolean
	...
	int				sendMessageLength;      // USED?
	byte			sendMessage [NET_MAXMESSAGE];
	unsigned int	receiveSequence;
	unsigned int	unreliableReceiveSequence;
#endif
    short maxMessageLength;
    short receiveMessageLength;
    void *driverdata;
...
extern const int net_numsockets;
...
extern const net_driver_t net_drivers[MAX_NET_DRIVERS];
extern ram_net_driver_t ram_net_drivers[MAX_NET_DRIVERS];
#if HAS_MULTIPLAYER
...
void SchedulePollProcedure(PollProcedure *pp, QDFLOAT timeOffset);
#if HAS_MULTIPLAYER
