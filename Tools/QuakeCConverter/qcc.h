...
#include "pr_comp.h"
#define GETTER_FUNCTIONS    1
#define PRINT_SYMBOL_INDEX  1
#define PRINT_SYMBOL_ARRAY  2
/*
...
#define FIXME(reason)   do {printf("fixme %s %d", reason,__LINE__); system("pause");}while(0)
...
typedef struct def_s
{
    ...
    // next_hack:
    int functionIndexUsed;      // 1 if this is a function and its index is used.
    char         *expression;       // used to create an expression for this definition
    char         *setterExpressionFormat;     // used for fields
    int isRealFunction;
} def_t;
...
extern int          g_compile_progs_dat;
typedef enum {
...
#define GLOBAL_STRUCT_NAME "progs"
...
//=============================================================================
#define MAX_TEMP_EXPRESSION_TYPE         1024
#define MAX_STRING_SYMBOL_LENGTH           32
