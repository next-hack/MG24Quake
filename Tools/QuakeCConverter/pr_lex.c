...
// check for $frame
	...
	else if (!strcmp(pr_token,"clearmacros"))
    {
        // skip to end of line
		while (PR_SimpleGetToken ())
		;
...
char *PR_ParseName (void)
{
    ...
    {
        snprintf(ident, sizeof(ident), "qcc_%s", pr_token);
    }
	PR_Lex ();
